...
export class InitDb1723977786166 implements MigrationInterface {
  name = 'InitDb1723977786166';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "roles" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "permissions" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" uuid, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('PENDING', 'REJECTED', 'APPROVED')`);
    await queryRunner.query(
