...
export class InitDb1725711566119 implements MigrationInterface {
    name = 'InitDb1725711566119'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "thai_provinces" ("id" SERIAL NOT NULL, "name_th" character varying, "name_en" character varying, "geography_id" integer, CONSTRAINT "PK_76655d0af0fafbc33f0b48ce2d2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "address" character varying NOT NULL, "country" character varying NOT NULL DEFAULT 'ไทย', "pincode" character varying, "phone" character varying NOT NULL, "isDefault" boolean NOT NULL DEFAULT true, "user_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "status" "public"."tag_status_enum" NOT NULL DEFAULT 'ACTIVE', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "blog_id" uuid, CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "type" character varying NOT NULL DEFAULT 'PRODUCT', "status" character varying NOT NULL DEFAULT 'ACTIVE', "thumbnail_id" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "review" ("id" SERIAL NOT NULL, "title" character varying, "description" character varying, "rating" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "product_id" uuid, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order_item" ("id" SERIAL NOT NULL, "order_id" uuid NOT NULL, "product_id" uuid NOT NULL, "quantity" integer NOT NULL, "price" integer NOT NULL, "discount" integer NOT NULL DEFAULT '0', "subtotal" integer NOT NULL, "total" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('PENDING', 'REJECTED', 'APPROVED', 'WAITING')`);
        await queryRunner.query(`CREATE TABLE "payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "payment_slip_url" character varying, "status" "public"."payments_status_enum" NOT NULL, "order_id" uuid, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "subtotal" integer NOT NULL DEFAULT '0', "total" integer NOT NULL DEFAULT '0', "user_id" uuid NOT NULL, CONSTRAINT "REL_f091e86a234693a49084b4c2c8" UNIQUE ("user_id"), CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "thai_tambons" ("id" SERIAL NOT NULL, "name_th" text, "name_en" text, "amphure_id" text, "zipcode" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_4c6db068ea7fff40c0714b4c0ce" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "thai_amphures" ("id" SERIAL NOT NULL, "name_th" character varying, "name_en" character varying, "province_id" integer, CONSTRAINT "PK_737cf23cba3b6dbcda92699b180" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_categories_category" ("productId" uuid NOT NULL, "categoryId" integer NOT NULL, CONSTRAINT "PK_17f2a361443184000ee8d79f240" PRIMARY KEY ("productId", "categoryId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product_galleries_media" ("productId" uuid NOT NULL, "mediaId" uuid NOT NULL, CONSTRAINT "PK_97101e7b4b449ca8b3c4710bf87" PRIMARY KEY ("productId", "mediaId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_e0aeeb1a38431e39777a9eb8a7" ON "product_galleries_media" ("productId") `);
        await queryRunner.query(`CREATE INDEX "IDX_daa16fa569e08808aa8311936b" ON "product_galleries_media" ("mediaId") `);
        await queryRunner.query(`CREATE TABLE "product_tags_tag" ("productId" uuid NOT NULL, "tagId" integer NOT NULL, CONSTRAINT "PK_8da52c0bc9255c6cb07af25ac73" PRIMARY KEY ("productId", "tagId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tag" ADD CONSTRAINT "FK_9831dcea17f367bca7454c98a56" FOREIGN KEY ("blog_id") REFERENCES "blog"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "blog" ADD CONSTRAINT "FK_d9b59d44da8be985dbb219a4883" FOREIGN KEY ("thumbnail_id") REFERENCES "media"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "category" ADD CONSTRAINT "FK_289f95936d346c27915df92de18" FOREIGN KEY ("thumbnail_id") REFERENCES "media"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_5cd3c8b06d45e575517e8358033" FOREIGN KEY ("thumbnail_id") REFERENCES "media"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product_galleries_media" ADD CONSTRAINT "FK_e0aeeb1a38431e39777a9eb8a7f" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "product_galleries_media" ADD CONSTRAINT "FK_daa16fa569e08808aa8311936b4" FOREIGN KEY ("mediaId") REFERENCES "media"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
